...
const char TEST_CHUNK_SWITCH_EXPECT[] =
    ...
    "0015    | OP_PRINT\n"
    "0016    5 OP_JUMP            16 -> 45\n"
    "0019    | OP_DUP\n"
    "0020    | OP_CONSTANT         5 '2'\n"
    "0022    | OP_EQUAL\n"
    "0023    | OP_JUMP_IF_FALSE   23 -> 32\n"
    "0026    6 OP_CONSTANT         6 'is two'\n"
    "0028    | OP_PRINT\n"
    "0029    7 OP_JUMP            29 -> 45\n"
    "0032    | OP_DUP\n"
    "0033    | OP_CONSTANT         7 '3'\n"
    "0035    | OP_EQUAL\n"
    "0036    | OP_JUMP_IF_FALSE   36 -> 42\n"
    "0039    8 OP_CONSTANT         8 'is three'\n"
    "0041    | OP_PRINT\n"
    "0042   10 OP_CONSTANT         9 'default case'\n"
    "0044    | OP_PRINT\n"
    "0045   11 OP_POP\n"
    "0046   12 OP_RETURN\n";
